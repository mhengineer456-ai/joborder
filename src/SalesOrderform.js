    ...
    <div style={styles.pageContainer}>
      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          {/* Production & Sales Order Workflow Pipeline */}
          <div style={styles.workflowContainer}>
            <div style={styles.workflowCard}>
              <div style={styles.workflowIcon}>📋</div>
              <div>
                <div style={styles.workflowTitle}>1. Order Booking Engine</div>
                <div style={styles.workflowSub}>Live sync with Google Sheets ERP master records</div>
              </div>
            </div>
            <div style={styles.workflowCard}>
              <div style={styles.workflowIcon}>📸</div>
              <div>
                <div style={styles.workflowTitle}>2. Cloud Media Sync</div>
                <div style={styles.workflowSub}>Automatic image compression & Drive cloud upload</div>
              </div>
            </div>
            <div style={styles.workflowCard}>
              <div style={styles.workflowIcon}>⚡</div>
              <div>
                <div style={styles.workflowTitle}>3. Downstream Ready</div>
                <div style={styles.workflowSub}>Auto-prepares Cutting Budget & Embroidery Challans</div>
              </div>
            </div>
          </div>
...
const styles = {
  ...
  workflowCard: {
    ...
    alignItems: 'center',
    gap: '14px',
    boxShadow: '0 10px 20px -3px rgba(37, 99, 235, 0.07)',
  },
  workflowIcon: {
    fontSize: '24px',
    width: '44px',
  ...
  card: {
    ...
    backgroundColor: '#ffffff',
    borderRadius: '20px',
    boxShadow: '0 20px 25px -5px rgba(37, 99, 235, 0.12), 0 8px 10px -6px rgba(15, 23, 42, 0.04)',
    overflow: 'hidden',
    border: '1px solid #cbd5e1',
  },
  header: {
